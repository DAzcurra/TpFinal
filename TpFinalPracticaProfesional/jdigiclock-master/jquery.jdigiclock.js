...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                imagesPath: 'dashboard/jdigiclock-master/images/',
                lang: 'En',
                am_pm: false,
            ...
            regional['en'] = {
                monthNames: ['Ene', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dic'],
            ...
            return this.each(function() {
                ...
                $this.clockImagesPath = o.imagesPath + 'jdigiclock-master/images/clock/';
                $this.weatherImagesPath = o.imagesPath + 'jdigiclock-master/images/weather/';
                $this.currDate = '';
                $this.timeUpdate = '';
                ...
                $this.find('#weather').html('<p class="loading">Update Weather ...<br><span style="font-size:16px;"><img src="jdigiclock-master/images/refresh_grey.png" alt="reload" title="reload" id="reload" /> Reload</span></p>');
             ...
             function (data) {
                ...
                if (typeof data.query.results !== 'undefined' && data.query.results != null) {
                    ...
                    var curr_temp = '<p class="temp">' + data.query.results.channel.item.condition.temp 
                     ...
                     el.find('#weather').append('<div id="bottom"><div id="soleil"></div><div id="update"><img src="jdigiclock-master/images/refresh_grey.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div></div>');
